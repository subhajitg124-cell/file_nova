...
const SITEMAP_URLS: SitemapUrl[] = [
  ...
  // Video Tools (via /tools/ catch-all)
  { loc: "/tools/trim",                            changefreq: "weekly", priority: 0.7,   lastmod: "2026-06-20" },
  { loc: "/tools/video-to-audio",                  changefreq: "weekly", priority: 0.7,   lastmod: "2026-06-20" },
  { loc: "/tools/video-to-gif",                    changefreq: "weekly", priority: 0.7,   lastmod: "2026-06-20" },
  { loc: "/tools/compress-audio",                  changefreq: "weekly", priority: 0.7,   lastmod: "2026-06-20" },
