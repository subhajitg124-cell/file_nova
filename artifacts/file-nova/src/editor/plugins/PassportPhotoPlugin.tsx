  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full p-6">
      <div className="flex flex-col items-center text-slate-400 dark:text-slate-500">
        ...
        <p className="text-sm font-bold text-slate-500 dark:text-slate-400">Passport Photo Editor</p>
        <p className="text-xs mt-1 text-slate-400 dark:text-slate-500">Resize to passport & visa photo sizes</p>
        {file && (
          <div className="mt-4 max-w-sm overflow-hidden rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700">
