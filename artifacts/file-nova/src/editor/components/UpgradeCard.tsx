...
export const UpgradeCard: React.FC<UpgradeCardProps> = ({
  ...
  >
    ...
    <div className="relative z-10">
      ...
      <p className="text-xs font-bold text-foreground/90 dark:text-foreground/90">{title}</p>
      <p className="text-[10px] text-muted-foreground/80 dark:text-muted-foreground mt-1 leading-relaxed">{description}</p>
      <button
        type="button"
