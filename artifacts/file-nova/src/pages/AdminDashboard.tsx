    ...
    <AdminLayout title="Dashboard Overview">
      ...
      <div className="flex gap-2 border-b border-white/[0.06] pb-0.5 mb-6">
        {(["overview", "subscriptions", "users"] as const).map((tab) => (
          ...
          >
            {tab === "overview" ? "Overview & Diagnostics" : tab === "subscriptions" ? "Billing & Revenue Analytics" : "Registered Directory"}
            {activeTab === tab && (
        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_1.5fr]">
            ...
            <div className="rounded-2xl border border-white/[0.06] bg-slate-950 p-5 flex flex-col justify-between relative overflow-hidden group">
              ...
              {/* Logs area */}
              <div className="flex-1 mt-6 overflow-y-auto max-h-60 pr-2 pt-2 terminal-scrollbar font-mono text-[10.5px] leading-relaxed text-slate-300 space-y-1">
                {logs.map((log, index) => {
