...
import { Video, Scissors, FileArchive, Music, RefreshCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-8">
        <div className="text-center space-y-4">
          ...
          <h1 className="text-3xl font-black text-foreground">Video Studio</h1>
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
            Trim, compress, convert videos and extract audio. Process video files efficiently.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto space-y-6 pt-8 border-t border-border">
          ...
          <details className="rounded-lg border border-border bg-card p-4">
            ...
            <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
              MP4, WebM, and most common video formats. Output is H.264 encoded for compatibility.
            </p>
          </details>
          <details className="rounded-lg border border-border bg-card p-4">
            <summary className="text-sm font-semibold text-foreground cursor-pointer">
            ...
            <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
              Yes! Use Extract Audio tool to convert video to MP3 audio files.
            </p>
          </details>
        </div>
      </div>
