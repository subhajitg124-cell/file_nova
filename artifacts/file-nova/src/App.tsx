...
const RotatePdf = React.lazy(() => import("@/tools/pdf/RotatePDFWorkspace"));
const UnlockPdf = React.lazy(() => import("@/tools/pdf/UnlockPDFWorkspace"));
const ProtectPdf = React.lazy(() => import("@/tools/pdf/ProtectPDFWorkspace"));
const ResizePdf = React.lazy(() => import("@/pages/tools/ResizePdf"));
const PanCardResize = React.lazy(() => import("@/tools/india/PANCardResizeWorkspace"));
const AadhaarMaskPdf = React.lazy(() => import("@/tools/india/AadhaarMaskWorkspace"));
...
const Ocr = React.lazy(() => import("@/tools/ocr/OCRScanWorkspace"));
const RemoveBackground = React.lazy(() => import("@/tools/image/BGRemoverWorkspace"));
const ScholarshipZip = React.lazy(() => import("@/tools/india/ScholarshipZIPWorkspace"));
