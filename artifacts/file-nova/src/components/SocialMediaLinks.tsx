...
const socialLinks = [
  ...
  },
  {
    ...
    iconSvg: (
      <svg viewBox="0 0 24 24" className="h-6 w-6 fill-current">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.6 6.8l-1.4 6.4c-.1.4-.4.5-.8.3l-1.9-.9-2.1 1.9c-.2.2-.4.3-.6.3-.1 0-.2 0-.3-.1l.3-1.9 5.8-5.2c.2-.2-.1-.3-.3-.2l-6.8 3.4-2.6.6c-.3 0-.4-.2-.3-.4l1.6-5.3 7.4-5c.3-.2.6 0 .4.2l-5.9 4.1-1.9 1.5c-.2.2-.2.4 0 .5l2 1.5 4.7 3.2c.3.2.5.1.6-.1z" />
      </svg>
    ),
    requiresTier: "pro",
  },
        ...
        {socialLinks.map((link, index) => {
          ...
          return (
            <motion.a
              ...
              className={`relative p-4 rounded-xl bg-gradient-to-r ${link.color} text-white overflow-hidden group cursor-pointer hover:shadow-lg transition-shadow duration-300 ${isLocked ? "opacity-60 grayscale-[0.8]" : ""}`}
            >
              <div className="relative z-10 flex items-center gap-3">
                ...
                {link.requiresTier && (
                  <span className="text-[10px] bg-yellow-400 text-gray-900 px-2 py-0.5 rounded font-semibold">
                    PRO+
                  </span>
                )}
              </div>
